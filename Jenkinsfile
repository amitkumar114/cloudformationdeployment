        ...
        stage('Deploy CloudFormation Stack') {
            steps {
                script {
                   ...
                   try {
                        sh 'aws cloudformation deploy --stack-name MyEC2Stack --template-file cloudformationdeployment/cf-deployment/ec2-template.yaml --capabilities CAPABILITY_NAMED_IAM'
                    } catch (Exception e) {
